...
<head>
    ...
    <script type="text/javascript">
        function submitInfo(dId) {
            ...
            window.location.href = "${APP_PATH}/emp/addEmpAdmin?empName=" + encodeURI(encodeURI(empName)) + "&password=" + password + "&empSex=" + empSex + "&deptId=" + deptId + "&empNo=" + empNo;
        }

        function genEmpNoByDeptId(deptId) {
            ...
            <div class="col-md-10" style="margin-top: 10%">
                <form id="updatePwd_form" class="form-horizontal" action="${APP_PATH}/dept/addDept" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" onchange="genEmpNoByDeptId('${employee.dId}')" class="form-control" name="empName" id="empName" placeholder="姓名...">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="deptId" class="col-sm-2 control-label">从属部门：</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="deptName" id="deptId" placeholder="${employee.department.deptName}"
                                  value="${employee.department.deptName}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="empNo" id="empNo" placeholder="工号..."
                                   disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="button" onclick="submitInfo('${employee.dId}')" class="btn btn-default">确定</button>
                        </div>
                    </div>
                </form>
            </div>
