            ...
            <div class="col-md-10" style="margin-top: 10%">
                <form id="updatePwd_form" class="form-horizontal" action="${APP_PATH}/dept/addDept" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="deptName" id="deptName" placeholder="名称...">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="deptDesc" id="deptDesc" placeholder="描述...">
                        </div>
                    </div>
