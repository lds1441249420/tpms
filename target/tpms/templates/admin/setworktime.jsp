    ...
    <div class="row" style="height: 85%;">
        ...
        <div id="context" class="col-md-8" style="height: 100%;">
            ...
            <div class="col-md-10" style="margin-top: 10%">
                <form id="form1" class="form-horizontal" action="${APP_PATH}/att/setWorkTimeByDeptId" method="post">

                    <div class="form-group">
                        <label for="timeWork" class="col-sm-2 control-label">上班时间：</label>
                        <div class="col-sm-10">
                            <input type="time" id="timeWork" name="timeWork" value="${attTime.timeWork}">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="timeOff" class="col-sm-2 control-label">下班时间：</label>
                        <div class="col-sm-10">
                            <input type="time" id="timeOff" name="timeOff" value="${attTime.timeOff}">
                        </div>
                    </div>
